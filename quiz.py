...
def play():
	...
	Unique=input("Enter Your Roll Number")
	score = 0
	...
	with open("assets/players.json","r+") as f:
		data=json.load(f)
		dic=dic={"Name":Name,"unique":Unique,"score":score}
		data.append(dic)
		f.seek(0)
		json.dump(data,f)
		f.truncate
...
def viewresult():
	c=0
	while c<4:
		print('1. VIEW ALL RESULT <ADMIN LOGIN REQUIRED>')
		print('2. VIEW YOUR RESULT')
		print('3. Exit RESULT VIEW')
		c=int(input("ENTER YOUR CHOICE: "))
		if c==1:
			if len(user) == 2 and user[1]=="ADMIN":
				with open("assets/players.json","r+") as f:
					data=json.load(f)
					for x in data:
						print(x)
			...
			key=input("ENTER YOUR ROLL NUMBER")
			with open("assets/players.json","r") as f:
				data=json.load(f)
				for x in data:
					i=0
...
def rules():
	print('''\n==========RULES==========
For Player :->
1.To start enter your Name and Unique key.Your result with your name and unique key is recorded. 
...
4. You can view your result using VIEW RESULT option.
	''')

def about():
	print('''\n==========ABOUT US==========
Project Team : Technocrats
Branch : CSE
Batch : 2019
Session : 2020-2021
Team Members
...
if __name__ == "__main__":
	...
	while choice != 7:
		...
		print('3. VIEW RESULT')
		print('4. LOGIN PANEL "ADMIN ONLY"')
